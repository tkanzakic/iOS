...
var duckduckgoReadability = function() {
...
function isProbablyReaderable(doc, isVisible) {
  ...
  return [].some.call(nodes, function(node) {
    ...
    function makeReadable() {
      console.log("readability.js makeReadable IN");
      var documentClone = document.cloneNode(true); 
      var article = new Readability(documentClone).parse();
      // document.getElementsByTagName("body")[0].innerHTML = article.content;

      webkit.messageHandlers.readableArticle.postMessage(article);

      console.log("readability.js makeReadable OUT", article);
    }
    ...
    (function() {
      ...
      try {
         var canRead = isProbablyReaderable(document);
         console.log("readability.js DOMContentLoaded canRead: " + canRead);
         webkit.messageHandlers.canRead.postMessage({
           canRead: canRead
         });
      } catch(error) {
